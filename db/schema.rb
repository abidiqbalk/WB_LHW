...
ActiveRecord::Schema.define(:version => 20120310124813) do
  ...
  create_table "gps_coordinates", :id => false, :force => true do |t|
    t.decimal "East",                            :precision => 12, :scale => 5
    t.decimal "North",                           :precision => 12, :scale => 5
    t.string  "School_name",       :limit => 54
    t.integer "EMIS_Code"
    t.string  "UnionCouncilname",  :limit => 27
    t.string  "Markaz",            :limit => 17
    t.string  "District",          :limit => 15
    t.integer "Srnumber"
    t.string  "VillageorMohallah", :limit => 34
    t.integer "Altitude"
    t.string  "GPSMark",           :limit => 4
  end
  ...
  create_table "table 27", :id => false, :force => true do |t|
    t.decimal "East (E)",                         :precision => 12, :scale => 5
    t.decimal "North (N)",                        :precision => 12, :scale => 5
    t.string  "School_name",        :limit => 54
    t.integer "EMIS_Code"
    t.string  "Union Council name", :limit => 27
    t.string  "Markaz",             :limit => 17
    t.string  "District",           :limit => 15
    t.integer "Sr.No."
    t.string  "Village/Mohallah",   :limit => 34
    t.integer "Altitude (Meter)"
    t.string  "GPS Mark.",          :limit => 4
  end
  ...
  create_table "temp", :id => false, :force => true do |t|
    t.integer "CTSC EmisCode"
    t.string  "Name of CTSC",  :limit => 29
    t.string  "EmisCode",      :limit => 9
    t.string  "School Name",   :limit => 44
    t.string  " Crap",         :limit => 3
  end

  create_table "temp2", :id => false, :force => true do |t|
    t.integer "CTSC Emiscode"
    t.string  "Name of CTSC",  :limit => 32
    t.integer "School EMIS"
    t.string  "School Name",   :limit => 36
  end
